...
def main():
    ...
    while(execucao_atual < quantidade_execucoes):
        for conteudo_linha in linhas[1:]:
            ...
            imagem = ler_imagem_entrada(caminho_imagem)#cv2.imread(caminho_imagem, cv2.IMREAD_GRAYSCALE)
            ...
            if modo == 'L':
                ...
                imagem_saida = aplicar_limiarizacao(imagem, valor_limiar, processos)

            elif modo == 'H':
                imagem_saida = aplicar_equalizacao_histograma(imagem, processos)
                ...
                imagem_saida = aplicar_correlacao(imagem, mascara, processos)
